                ...
                <div className="bg-white border border-dark/10 p-4 mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-2 overflow-x-auto pb-2 md:pb-0 scrollbar-none">
                        <button
                            ...
                            className={`px-4 py-2 text-xs font-bold uppercase tracking-wider whitespace-nowrap transition-colors ${activeTab === "all" ? "bg-dark text-white" : "bg-[#F7F3F4] text-dark/70 hover:text-dark"
                                }`}
                        >
                            All Orders
                        </button>
                        <button
                            ...
                            className={`px-4 py-2 text-xs font-bold uppercase tracking-wider whitespace-nowrap transition-colors ${activeTab === "confirmed" ? "bg-dark text-white" : "bg-[#F7F3F4] text-dark/70 hover:text-dark"
                                }`}
                        >
                            Confirmed
                        </button>
                        <button
                            ...
                            className={`px-4 py-2 text-xs font-bold uppercase tracking-wider whitespace-nowrap transition-colors ${activeTab === "out_for_delivery" ? "bg-dark text-white" : "bg-[#F7F3F4] text-dark/70 hover:text-dark"
                                }`}
                        >
                            Out for Delivery
                        </button>
                        <button
                            ...
                            className={`px-4 py-2 text-xs font-bold uppercase tracking-wider whitespace-nowrap transition-colors ${activeTab === "delivered" ? "bg-dark text-white" : "bg-[#F7F3F4] text-dark/70 hover:text-dark"
                                }`}
                        >
                            Delivered
                        </button>
                                    ...
                                    <div className="p-6 md:p-8 flex flex-col md:flex-row md:items-center justify-between gap-6 bg-white">
                                        <div className="flex-1">
                                            <div className="flex items-center gap-3 mb-2 flex-wrap">
                                                ...
                                                <span className={`text-[9px] uppercase tracking-wider font-bold px-2.5 py-1 border ${isPaid ? 'bg-emerald-50 text-emerald-700 border-emerald-200' : 'bg-amber-50 text-amber-700 border-amber-200'
                                                    }`}>
